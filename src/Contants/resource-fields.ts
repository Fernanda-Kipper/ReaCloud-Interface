...
export const RESOURCE_FIELDS = [
  ...
  {name:'Quando o recurso foi criado' , field: (data: Resource) => data?.date_of_publishment ?? '', property: 'dc.data'},
  ...
  {name:'Palavras chave' , field: (data: Resource) => data?.keywords ?? '', property: 'dc.data'},
  ...
  {name:'Ultima modificação na plataforma' , field: (resource: Resource) => resource?.last_modification ?? '', property: 'dc.last_modification'},
